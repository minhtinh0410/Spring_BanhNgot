...
<c:url value = "/view/client/assets" var="url"/>
  ...
  <section id="aa-catg-head-banner">
   <img src="${pageContext.request.contextPath}/view/client/assets/images/BanhNgotBanner.jpg" alt="banner sản phẩm">
  ...
  <section id="aa-product-category">
    <div class="container">
      <div class="row">
      	<div>
      		<h1 style ="text-align: center; color: red;">THP Cake</h1>
      		<p>Chúng tôi hi vọng tất cả người tiêu dùng Việt nam sẽ được sử dụng những thụ phẩm rau củ quả tươi ngon, bổ dưỡng và an toàn nhất tại cửa hàng cung
      		 cấp thực phẩm rau củ sạch <strong>THP Cake</strong>.Với sứ mệnh trở thành một trong những nhà cung cấp thực phẩm sạch hàng đầu tại
      		 Việt Nam đưa đến người tiêu dùng loại nông sản tươi ngon nhất của các vùng miền trên toàn quốc với mục đích là 
      		<strong>“Mang thiên nhiên về với căn nhà của bạn”</strong>. Với quy trình lựa chọn và kiểm soát nghiêm ngặt THP Cake đã tạo nên quỹ đầu tư chuyên thu mua 
      		...
      		nhất trong từng sản phẩm khác biệt từ thiên nhiên.</p>
                <img src="${url}/images/BanhNgotY.jpg" alt="Thực phẩm sạch" width="1160px"/> <br/> <br>
      		...
      		chất bảo quản nào bị Bộ Y Tế cấm không được sử dụng và cam kết với quý khách hàng về toàn bộ những sản phẩm được phân phối qua hệ thống phân phối  <strong>THP Cake</strong>
      		...
      		<img src="${url}/images/BanhNgotVietNam.jpg" alt="Thực phẩm sạch" width= "1160" height= "600"/> <br/> <br>
			...
			Với những loại rau củ là những loại đặc sản tại các vùng miền <strong>THP Cake</strong> là địa chỉ uy tín cung cấp cho bạn các loại sản phẩm chất lượng từ các loại  
