                        ...
                        <div class="col-md-5 no-padding">                
                            <div class="aa-promo-left">
                                <div class="aa-promo-banner">                    
                                    <img src="${url}/images/BanhBongLan.jpg" alt="dâu tây Đà Lạt">                    
                                    <div class="aa-prom-content">
                                        <span>Giảm giá 32%</span>
                                        <h4>Bánh ngọt bông lan</h4>                      
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-md-7 no-padding">
                            <div class="aa-promo-right">
                                <div class="aa-single-promo-right">
                                    <div class="aa-promo-banner">                      
                                        <img src="${url}/images/BanhDauXanh.jpg" alt="hạt tiêu daklak">                      
                                        <div class="aa-prom-content">
                                ...
                                <div class="aa-single-promo-right">
                                    <div class="aa-promo-banner">                      
                                        <img src="${url}/images/Panforte.jpg" alt="img">                      
                                        <div class="aa-prom-content">
                                            <span>Sản phẩm nhập khẩu</span>
                                            <h4>Bánh ngọt Ý Panforte</h4>                        
                                        </div>
                                    </div>
                                </div>
                                <div class="aa-single-promo-right">
                                    <div class="aa-promo-banner">                      
                                        <img src="${url}/images/BanhRanDoremon.jpg" alt="img">                      
                                        <div class="aa-prom-content">
                                            <span>Giảm giá 25%</span>
                                            <h4>Bánh rán Doremon</h4>                        
                                        </div>
                                    </div>
                                </div>
                                <div class="aa-single-promo-right">
                                    <div class="aa-promo-banner">                      
                                        <img src="${url}/images/BanhQueHoa.jpg" alt="img">                      
                                        <div class="aa-prom-content">
                                            <span>Sản phẩm độc quyền</span>
                                            <h4>Bánh Quế Hoa</h4>                        
                                        </div>
                    ...
                    <div class="aa-product-area">
                        <div class="aa-product-inner">
                            ...
                            <ul class="nav nav-tabs aa-products-tab">
                                <li class="active"><a href="#raucu" data-toggle="tab">Bánh ngọt Việt Nam</a></li>
                                <li><a href="#hat" data-toggle="tab">Bánh ngọt Nhật Bản</a></li>
                                <li><a href="#traicay" data-toggle="tab">Bánh ngọt Ý</a></li>
                                <li><a href="#matong" data-toggle="tab">Bánh ngọt Trung Quốc</a></li>
                            </ul>
                            <!-- Tab panes -->
                                ...
                                <div class="tab-pane fade in active" id="raucu">
                                    <ul class="aa-product-catg">
                                        ...
                                        <c:forEach items="${product_raucu}" var="product" end="7">
                                            <li>
                                                <figure>
                                                    <a class="aa-product-img" href="${pageContext.request.contextPath}/view/client/product-detail?id=${product.id}"><img src="${pageContext.request.contextPath}/view/client/assets/images/products/img-test/BanhNgotVietNam.jpg" alt="polo shirt img"></a>
                            ...
                            <c:url var="all" value="/view/client/product.jsp" />
            ...
            <div class="col-md-12">        
                <div class="row">
                    <div class="aa-banner-area">
                        <a href="#"><img src="${url}/images/BanhNgotBanner.jpg" alt="banner trang chủ"></a>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="col-md-12">
                <div class="row">
                    <div class="aa-popular-category-area">
                        ...
                        <div class="more-product">
                            <a class="aa-browse-btn" href="${pageContext.request.contextPath}/view/client/product.jsp">Xem Tất Cả Sản Phẩm <span class="fa fa-long-arrow-right"></span></a>
                        </div>
                    </div>
                </div> 
            </div>
                ...
                <div class="aa-support-area">
                    ...
                    <div class="col-md-4 col-sm-4 col-xs-12">
                        <div class="aa-support-single">
                            ...
                            <P>Chúng tôi đã áp dụng gói miễn phí vận chuyển cho đơn hàng trên 500.000VNĐ.</P>
                        </div>
                    </div>
                    <!-- single support -->
                    <div class="col-md-4 col-sm-4 col-xs-12">
                    ...
                    <ul class="aa-testimonial-slider">
                        ...
                        <li>
                            <div class="aa-testimonial-single">
                                <img class="aa-testimonial-img" src="${url}/images/avatar-tinh.jpg" alt="avatar 1">
                        ...
                        <li>
                            <div class="aa-testimonial-single">
                                <img class="aa-testimonial-img" src="${url}/images/avatar-huy.jpg" alt="avatar 2">
                                <span class="fa fa-quote-left aa-testimonial-quote"></span>
                        ...
                        <li>
                            <div class="aa-testimonial-single">
                                <img class="aa-testimonial-img" src="${url}/images/avatar-phuc.jpg" alt="avatar 3">
                                <span class="fa fa-quote-left aa-testimonial-quote"></span>
